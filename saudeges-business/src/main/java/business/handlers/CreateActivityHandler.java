...
public class CreateActivityHandler {
	...
	public List<SpecialtyDTO> getSpecialities() {
		List<Specialty> specialties = sc.getSpecialties();
		List<SpecialtyDTO> specialtiesDTO = new ArrayList<>();
		for (Specialty specialty : specialties) {
			SpecialtyDTO specialtyDTO = new SpecialtyDTO(specialty);
			specialtiesDTO.add(specialtyDTO);
		}
	 ...
	 *                              the activity
	 */
	private boolean isValidNumSessions(boolean isRegular, int numSessions, long price) {
		if (isRegular) {
