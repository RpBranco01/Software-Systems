...
public class Main {
    ...
    @EJB
    private static ICreateActivityServiceRemote createActivity;

    @EJB
    private static ISetNewScheduleServiceRemote setSchedule;
    ...
    public static void main(String[] args) {
    	presentation.fx.Startup.startGUI(createActivity, setSchedule);
    }
}